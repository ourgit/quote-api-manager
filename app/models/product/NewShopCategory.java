 ...
 */
@Entity
@Table(name = "v1_new_shop_category")
public class NewShopCategory extends Model {
    ...
    @Transient
    public List<NewShopCategory> children;

    public static Finder<Long, NewShopCategory> find = new Finder<>(NewShopCategory.class);
    ...
    public List<NewShopCategory> getChildren() {
        return children;
    }

    public void setChildren(List<NewShopCategory> children) {
